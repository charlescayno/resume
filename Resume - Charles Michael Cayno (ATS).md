...
- **Power Electronics & Topologies:** AC-DC Converters, DC-DC Converters, Flyback, Buck, Boost, Flyboost, Resonant Converters (LLC), Switch-Mode Power Supplies (SMPS), Power Factor Correction (PFC), Switch Valley-Fill (SVF), Zero-Voltage Switching (ZVS), GaN / PowiGaN Technology, Qi Wireless Charging, USB Power Delivery (USB PD 3.0 / 3.1 EPR).
- **Circuit Design & Simulation:** SIMetrix, SIMPLIS, LTspice, MATLAB, Simulink, Schematic Capture, Transformer & Inductor Design, Ferrite Core Selection, Winding Design.
- **PCB Layout & Tools:** Altium Designer, OrCAD Allegro, KiCad, High-Voltage Layout Design, Creepage & Clearance Compliance, Thermal Layout Optimization.
- **Compliance & Testing:** EMI/EMC Compliance (CISPR 22 / EN 55022 Class B), Safety Standards (IEC 61000, UL, FCC, CCC), Conducted Immunity Testing (ESD, Surge), Thermal Analysis.
...
- Lead the end-to-end design, topology selection, and hardware development of high-efficiency AC-DC and DC-DC power supply systems for smart home automation and lighting applications.
- Architect high-power-density power supply designs with optimized thermal management and low electromagnetic interference (EMI).
- Execute detailed magnetic design, thermal dissipation calculations, and PCB layout reviews to comply with international safety and EMC standards.
- Collaborate with cross-functional engineering teams including firmware, mechanical, and compliance units to ensure product safety and reliability.
- Mentor junior engineers and provide technical oversight across laboratory evaluation and testing protocols.

**Selected Projects:**
- **DER-1050 (82W Smart Clothes-Dryer Rack Flyback Supply):** Designed an 82W flyback converter with 2 CV and 1 CC outputs using InnoMux2-EP and Switch Valley-Fill (SVF) passive PFC. Achieved low total harmonic distortion (THD) and high power factor to meet China CCC lighting compliance standards. Featured at PCIM 2025.
- **DER-1081 (50W Emergency Smart Lighting Supply):** Developed a slim-profile (9.78 in x 1.06 in x 0.63 in) 50W flyback power supply with 1 CV and 1 CC output, high power factor (>0.90), low THD (<15%), and 1-wire PWM dimming.
...
- **DER-945 (75W Dimmable LED Driver):** Designed and tested a 75W 3-in-1 dimmable LED driver using LYTSwitch-8 in Flyboost topology, presented at FAEC 2022.
