...
**Selected Projects:**
- **High-Voltage Server Auxiliary Power Supply (215W / 1700V Integrated Switcher Architecture):** Architected and evaluated a 215W peak (170W continuous) 48V/3.55A auxiliary power supply for data center and server power delivery architectures operating from a 700V–860V DC bus using a 1700V integrated power switcher IC. Designed custom PQ32/20 power magnetics, executed custom secondary IC trim configuration, developed specialized interposer test hardware with 3D-printed forced-air thermal mounting, and implemented automated Python ATE routines for efficiency and transient characterization.
