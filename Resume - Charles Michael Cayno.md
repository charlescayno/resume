...
Results-driven, detail-oriented, and highly resilient **Senior Power Supply Design Engineer** with over 5 years of experience in the design, development, and validation of high-efficiency power supply systems. Demonstrated expertise in AC-DC and DC-DC converter design, magnetic component design, thermal analysis, and EMI/EMC mitigation. Adept at collaborating with cross-functional teams to transform innovative power electronics concepts into reliable hardware. Solid background in embedded digital power control, along with knowledge of regulatory compliance standards including IEC, UL, and FCC. Committed to applying industry best practices to deliver robust, high-performance solutions in fast-paced engineering environments.
...
- Lead the design and development of high-efficiency power supply systems, including AC-DC and DC-DC converters, with a focus on home automation and lighting applications.
- Optimize power electronics architectures to achieve high power density, low EMI, and thermal efficiency.
- Conduct detailed analysis of magnetics, thermal characteristics, and circuit performance for optimized designs.
- Perform PCB layout reviews, ensuring compliance with EMI/EMC and thermal management requirements.
- Collaborate with cross-functional teams, including firmware engineers, mechanical engineers, and compliance experts, to ensure product reliability and safety.
- Mentor junior engineers and provide technical leadership in power electronics design and testing.

**Projects Accomplished:**
- **DER-1050** *(82 W Flyback Power Supply for Smart Clothes-Dryer Rack with 2 CV & 1 CC Outputs Using InnoMux2-EP)*
  - Featured in PCIM 2025. First attempt to incorporate Switch Valley-Fill (SVF) passive PFC on InnoMux-2.
  - First 2 CV, 1 CC design for InnoMux-2.
  - Debugged and resolved issues such as AC cycling, low PF, and high THD by coordinating with other teams to re-trim existing IC.
  - Designed a high-power factor, low THD system during light load to comply with certification agencies like CCC in China (classifying smart clothes-dryer racks as lighting appliances starting Jan 1, 2025).
- **DER-1081** *(50 W Flyback Power Supply for Emergency Smart Lighting with 1 CV & 1 CC Outputs Using InnoMux2-EP)*
  - Ongoing project similar to DER-1050 with 1 CV & 1 CC output requirement.
  - Slim profile design ($9.78\text{ in} \times 1.06\text{ in} \times 0.63\text{ in}$) featuring high power factor ($> 0.9$) at 50 W, low THD ($< 15\%$), and 1-wire filtered PWM dimming.
...
- **Power Electronics:** AC-DC, DC-DC, Inverters, Rectifiers, SMPS, Isolated & Non-Isolated Converters
- **Circuit Design & Simulation:** SIMetrix, SIMPLIS, LTspice, MATLAB, Simulink
- **Magnetics Design:** Transformers, Inductors, Ferrite Core Selection, Winding Techniques
- **PCB Design & Layout:** Altium Designer, OrCAD, KiCad
- **Embedded Power Control:** Digital Power Controllers, DSPs, Microcontrollers (MCUs)
- **Thermal Management:** Heat Sink Design, Power Dissipation Analysis
- **Compliance & Testing:** EMI/EMC Compliance (CISPR, FCC), Safety Standards (UL, IEC, ISO)
- **Prototyping & Debugging:** Oscilloscopes, Spectrum Analyzers, Load Testing
- **Software & Scripting:** Python, MATLAB, C/C++ (for embedded power applications)
...
- **Project Leadership:** Team mentoring, cross-functional collaboration, Agile methodologies
